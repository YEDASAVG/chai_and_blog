      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2">
            <Image src="/logo.png" alt="ChaiAndBlog" width={40} height={40} className="w-10 h-10" />
            <span className="text-2xl font-bold font-[family-name:var(--font-brand)] tracking-tight text-white">
        ...
        <div className="bg-[#1a1a1a] border border-gray-800 rounded-2xl p-8">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-4 py-3.5 bg-[#0a0a0a] border border-gray-700 rounded-xl text-white font-medium hover:bg-gray-900 hover:border-gray-600 transition-all"
            >
              <svg data-lingo-skip className="w-5 h-5" viewBox="0 0 24 24">
